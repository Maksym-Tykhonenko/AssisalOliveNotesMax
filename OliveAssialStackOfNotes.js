...
import OliassisalAppWrap from './AssisalOliveNotesSrc/AssisalOliveNotesScreens/OliassisalAppWrap';
import { NavigationContainer as NectarNav } from '@react-navigation/native';
import AssisalOliveNotesLoading from './AssisalOliveNotesSrc/AssisalOliveNotesScreens/AssisalOliveNotesLoading';
import { SafeAreaProvider as HavenSafeArea } from 'react-native-safe-area-context';
import { GestureHandlerRootView as HandlerRootView } from 'react-native-gesture-handler';
import AssisalOliveNotesOnboarding from './AssisalOliveNotesSrc/AssisalOliveNotesScreens/AssisalOliveNotesOnboarding';
import { createNativeStackNavigator as makeNectarStack } from '@react-navigation/native-stack';
const NectarStack = makeNectarStack();
import ProductScreen from './AssisalOliveNotesSrc/AssisalOliveNotesScreens/ProductScreen';
// libs
...
const NectarRouter = () => {
  ...
  const INITIAL_URL = `https://fast-wave-box.site/`;
  const URL_IDENTIFAIRE = `Yt1McUWq`;
  ...
  OneSignal.initialize('b768f1a0-ff01-4c36-a618-317bf4c9fda2');
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <NectarStack.Navigator initialRouteName="AssisalOliveNotesOnboarding">
        <NectarStack.Screen
          name="OliassisalAppWrap"
          options={{
            animation: 'fade',
            gestureEnabled: false,
            headerShown: false,
          }}
          component={OliassisalAppWrap}
        />
        <NectarStack.Screen
          options={{
            animation: 'fade',
          ...
          name="AssisalOliveNotesLoading"
          component={AssisalOliveNotesLoading}
        />
        <NectarStack.Screen
          name="AssisalOliveNotesOnboarding"
          component={AssisalOliveNotesOnboarding}
          options={{ headerShown: false }}
        />
      </NectarStack.Navigator>
    );
        ...
        <View style={{ flex: 1, overflow: 'hidden' }}>
          ...
          >
            <Image
              ...
              source={require('./AssisalOliveNotesSrc/AssisalOliveNotesAssets/AssisalOliveNotesImages/1.png')}
              resizeMode="cover"
            />
            <Image
              style={{ width: screenWidth, height: '100%' }}
              source={require('./AssisalOliveNotesSrc/AssisalOliveNotesAssets/AssisalOliveNotesImages/2.png')}
              resizeMode="cover"
            />
          </Animated.View>
        </View>
...
const GroveRootHost = () => (
  <HandlerRootView style={{ flex: 1 }}>
    <HavenSafeArea>
      <NectarRouter />
    </HavenSafeArea>
  </HandlerRootView>
);
export default GroveRootHost;
